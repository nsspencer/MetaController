...
class PreferenceArgumentImplementationTests(unittest.TestCase):
    def test_positional_arg(self):
        class T(C):
            def sort_cmp(self, a: Any, b: Any, pos_arg: int) -> int:
                if pos_arg == 1:
    ...
    def test_keyword_arg(self):
        class T(C):
            def sort_cmp(self, a: Any, b: Any, keyword_arg: int = 1) -> int:
                if keyword_arg == 1:
                    return -1 if a < b else 1 if a > b else 0
                else:
                    return 1 if a < b else -1 if a > b else 0
    ...
    def test_arg_unpack(self):
        class T(C):
            def sort_cmp(self, a: Any, b: Any, *args) -> int:
                if args[0] == 1:
                    return -1 if a < b else 1 if a > b else 0
                else:
                    return 1 if a < b else -1 if a > b else 0
    ...
    def test_kwarg_unpack(self):
        class T(C):
            def sort_cmp(self, a: Any, b: Any, **kwargs) -> int:
...
class ArgsAndKwargsTests(unittest.TestCase):
    ...
    def test_action_and_filter_and_preference_pos_arg(self):
        class T(C):
            ...
            def sort_cmp(self, a: Any, b: Any, pref_pos_arg: int) -> int:
                if pref_pos_arg == 2:
                    return -1 if a < b else 1 if a > b else 0
                return 1 if a < b else -1 if a > b else 0
    ...
    def test_action_and_filter_and_preference_keyword_arg(self):
        class T(C):
            ...
            def sort_cmp(self, a: Any, b: Any, pref_arg: int = 2) -> int:
                if pref_arg == 2:
                    return -1 if a < b else 1 if a > b else 0
                return 1 if a < b else -1 if a > b else 0
