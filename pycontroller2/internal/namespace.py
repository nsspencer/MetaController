...
####
# Methods
PRE_CONTROLLER_METHOD_NAME = "pre_controller"
FILTER_METHOD_NAME = "filter"
PREFERENCE_KEY_METHOD_NAME = "preference_key"
PREFERENCE_CMP_METHOD_NAME = "preference_cmp"
...
RESERVED_KEYWORDS = {
    ...
    PARTITION_ARG_NAME,
    K_ARG_NAME,
    PREFERENCE_ARG_A_NAME,
    PREFERENCE_ARG_B_NAME,
